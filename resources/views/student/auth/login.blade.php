...
@section('title', 'Acceso alumno — ' . config('app.name'))
        ...
        <div class="row justify-content-center align-items-center min-vh-100 py-5">
            <div class="col-12 col-sm-10 col-md-8 col-lg-5 col-xl-4">
                <div class="text-center mb-4 text-white">
                    ...
                    <h1 class="h4 fw-bold mb-1">Portal del alumno</h1>
                    <p class="opacity-75 small mb-0">Reserva tus clases de manejo</p>
                </div>

                <div class="card auth-card border-0">
                    <div class="card-body p-4 p-md-5">
                        <h2 class="h5 fw-semibold mb-1 text-center">Iniciar sesión</h2>
                        <p class="text-muted small text-center mb-4">Usa el correo con el que te registraron</p>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input
                                        ...
                                        placeholder="alumno@agenda-maxpi.test"
                                    >
                                </div>
                            </div>
                        ...
                        <p class="text-center text-muted small mt-4 mb-2">
                            ¿Eres instructor?
                            <a href="{{ route('instructor.login') }}" class="text-decoration-none">Acceso instructor</a>
                        </p>
